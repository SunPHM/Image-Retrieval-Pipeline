...
public class Frequency_seq {
	...
	public static void init(String features, int clusterNum, String clusters){
		Frequency_seq.clusterNum = clusterNum;
		Frequency_seq.clusters = clusters;
		Frequency_seq.features = features;
	}
	
	public static void runJob (String features, int clusterNum, String clusters, String temp, String output){
		Frequency_seq.init(features, clusterNum, clusters);
	...
	public static void runFreMR(String infile, String outfile){
		...
		JobConf conf = new JobConf(Frequency_seq.class);
		conf.setJobName("Frequency_seq");
